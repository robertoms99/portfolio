                ...
                <div className="project__content">
                    <div className="project__heading">
                        ...
                        <div className="project__options">
                            {project.links.web && (
                                <Link className="project__link" title="ir al sitio" href={project.links.web}  target="_blank">
                                    <Icon className="project__icon" SvgElement={ExternalIcon} />
                                </Link>
                            )}
                            <Link className="project__link" title="ver codigo" href={project.links.github}  target="_blank">
